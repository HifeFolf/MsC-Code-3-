...
# X-axis of time series = MP4 timestamp in seconds, so you can jump to
# any feature you spot in the graphs.
#
...
function main()
    ...
    t_line  = Observable([0.0f0])   # vertical time-cursor for vlines!
